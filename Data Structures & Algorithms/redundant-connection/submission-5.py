class Solution:
    def findRedundantConnection(self, edges: List[List[int]]) -> List[int]:
        ...
        #So, we need to return the edge that was last to be put, and since the DFS results are based on adjacency list and not exactly ordered, we need to only keep track and return the last possible edge to remove.
