    ...
    def minEatingSpeed(self, piles: List[int], h: int) -> int:
        ...
        while low <= high:
            ...
            if total > h:
                ...
                result = min(result, middle) #Another way, we keep track of the running minimum all the way. Until we crossover the lows and highs --> then whats left is the minimum k needed.
                high = middle -1
