    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        while low <= high:
            ...
            if timestamps[middle] <= timestamp:
                latest_timestamp = timestamps[middle] #keep track of the latest correct timestamp. If we find a more recent one, then update. Else, we will stick to this running latest.
                low = middle + 1
