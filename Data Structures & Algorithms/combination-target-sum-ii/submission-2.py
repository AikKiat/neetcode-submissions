        ...
        def recurse_and_return(index, subset, total):
            ...
            for i in range(index, len(candidates)):
                if i > index and candidates[i] == candidates[i-1]:
                    continue #we must go past the index first, and then once we are past it, we are exploring all the possible branches under this chosen, given root which is represented by the element at index.
